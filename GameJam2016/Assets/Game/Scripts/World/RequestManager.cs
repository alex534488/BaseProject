...
public class RequestManager : MonoBehaviour
{
    ...
    void GenerateRandomRequests()
    {
        ...
        listeChoix.Add(new Dialog.Choix("J’entends votre requête et je vais faire le nécessaire pour qu'il retourne auprès de sa famille. (-1 Soldat +1 Bonheur)", delegate () { Empire.instance.capitale.AddArmy(-1); Empire.instance.capitale.AddBonheur(1); }));
        listeChoix.Add(new Dialog.Choix("Chaque soldat à un rôle crucial dans l'armée, mais j'ai espoir que cette compensation en or puisse couvrir vos besoins pendant son absence. (-8 Or)", delegate () { Empire.instance.capitale.AddGold(-8); }));
        listeChoix.Add(new Dialog.Choix("Malheureusement, en ces temps difficiles, chaque famille porte la même histoire, je ne peux accéder à votre requête. (-2 Bonheur)", delegate () { Empire.instance.capitale.AddBonheur(-2); }));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Sauvez les femmes et les enfants en priorité, mais malheureusement, les soldats ne peuvent franchir le Rubicon. (-16 Nourriture)", delegate () { Empire.instance.capitale.AddFood(-16); }));
        listeChoix.Add(new Dialog.Choix("Sauvez les réserve de nourritures en priorité, mais malheureusement, les soldats ne peuvent franchir le Rubicon. (-8 Bonheur)", delegate () { Empire.instance.capitale.AddBonheur(-8); }));
        listeChoix.Add(new Dialog.Choix("Que les armées franchisent le Rubicon et aillent aider Rome ! (-6 soldats)", delegate () { Empire.instance.capitale.AddArmy(-6); }));
        request = new Request(listMessage, listeChoix);
        listRandomRequest.Add(request);
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("D'excellentes récoltes évidemment ! (+1 Production Nourriture)", delegate () { Empire.instance.capitale.AddFoodProd(1); }));
        ...
        listeChoix.Add(new Dialog.Choix("Payer ce sage, et faites lui comprendre qu'il est dans son intérêt de réussir la maladie s’il veut conserver sa tête ! (-12 Or)", delegate () { Empire.instance.capitale.AddGold(-12); }));
        listeChoix.Add(new Dialog.Choix("Faite pendre cet escroc et réquisitionnez ses affaires personnelles ! (-2 Bonheur, -4 Nourriture, + 10 Or)", delegate () { Empire.instance.capitale.AddBonheur(-2); Empire.instance.capitale.AddFood(-4); Empire.instance.capitale.AddGold(10); }));
        request = new Request(listMessage, listeChoix);
        listRandomRequest.Add(request);
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Sacrifiez du bétails ! (-8 Nourriture)", delegate () { Empire.instance.capitale.AddFood(-8); }));
        listeChoix.Add(new Dialog.Choix("Organisez une fête populaire où le bétail sera sacrifié et la population rassasiée (-16 Nourriture, +4 Bonheur)", delegate () { Empire.instance.capitale.AddFood(-16); Empire.instance.capitale.AddBonheur(2); }));
        listeChoix.Add(new Dialog.Choix("Jupiter n'est qu'une représentation du seul et unique Dieu ! Je ne crains pas ses foudres! (-3 Bonheur)", delegate () { Empire.instance.capitale.AddBonheur(-3); }));
        request = new Request(listMessage, listeChoix);
        listRandomRequest.Add(request);
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Discréditez les représentant des chrétiens avec des rumeurs de péchés capitaux. (-8 Or)", delegate () { Empire.instance.capitale.AddGold(-8); }));
        listeChoix.Add(new Dialog.Choix("Créez de faux mauvais augures pour apeurer les Païens. (-2 Bonheur)", delegate () { Empire.instance.capitale.AddBonheur(-2); }));
        listeChoix.Add(new Dialog.Choix("Créez l'étincelle qui enflammera le débat, et envoyez l'armée pour nettoyer les rue de ces croyants imbéciles ! (-4 Soldat)", delegate () { Empire.instance.capitale.AddArmy(-4); }));
        request = new Request(listMessage, listeChoix);
        listRandomRequest.Add(request);
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Je vous offre le ravitaillement nécessaire à votre expédition ! (-8 Nourriture)", delegate () { Empire.instance.capitale.AddFood(-8); listRandomRequest.Remove(expeEvent);listRandomRequest.Add(ExpeditionEvent2()); }));
        listeChoix.Add(new Dialog.Choix("Je vous offre les marins nécessaires à votre expédition ! (-4 Soldat)", delegate () { Empire.instance.capitale.AddArmy(-4); listRandomRequest.Remove(expeEvent); listRandomRequest.Add(ExpeditionEvent2()); }));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Intéressante proposition. Prévenez vos amis, j'accepte leur offre. (-20 Or +7 Soldats)", delegate () { Empire.instance.capitale.AddGold(-20); Empire.instance.capitale.AddArmy(7); }));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Bien sur, voici une somme raisonnable qui devrait vous aider dans cette quête. (-20 Or)", delegate () { Empire.instance.capitale.AddGold(-20);listRandomRequest.Remove(potionEvent1); listRandomRequest.Add(PotionEvent2()); }));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Achetez-lui de la nourriture. (+5 Nourriture, -5 Or)", delegate () { Empire.instance.capitale.AddFood(5); Empire.instance.capitale.AddGold(-5); }));
        listeChoix.Add(new Dialog.Choix("Achetez-lui des mets exotiques pour la population.\n(+5 Bonheur, -25 Or)", delegate () { Empire.instance.capitale.AddBonheur(5); Empire.instance.capitale.AddGold(-25); }));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Vendez-lui le quart de nos réserves ! (25% de vente à 4 Or par Nourriture vendu)", delegate () { int n = (int)(Empire.instance.capitale.GetFood() * 0.25); Empire.instance.capitale.AddFood(-n); Empire.instance.capitale.AddGold(n * 4); }));
        listeChoix.Add(new Dialog.Choix("Vendez-lui la moitié de nos réserves ! (50% de vente à 4 Or par Nourriture vendu)", delegate () {int n =(int)( Empire.instance.capitale.GetFood() * 0.5); Empire.instance.capitale.AddFood(-n); Empire.instance.capitale.AddGold(n * 4); }));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Bien, voici de l'or pour commencer l’exploitation. (+4 Production Or, -40 Or)", delegate () { Empire.instance.capitale.AddGold(-40); Empire.instance.capitale.AddGoldProd(4); }));
        listeChoix.Add(new Dialog.Choix("Je suis certain que la population sera ravie de participer à des travaux forcés dans cette nouvelle mine ! (+4 Production Or, -5 Bonheur)", delegate () { Empire.instance.capitale.AddBonheur(-5); Empire.instance.capitale.AddGoldProd(4); }));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("L’état des récoltes ne me permet pas de vous offrir de la nourriture, mais voici une compensation financière \n(-5 Or, +1 Bonheur)", delegate () { Empire.instance.capitale.AddGold(-5); Empire.instance.capitale.AddBonheur(1); }));
        listeChoix.Add(new Dialog.Choix("J’entends votre requête et vous offre de la nourriture en échange des loyaux services de votre mari tombé au combat. (-3 Nourriture, +1 Bonheur)", delegate () { Empire.instance.capitale.AddFood(-3); Empire.instance.capitale.AddBonheur(1); }));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Mes Citoyens vont les récolter et vous serez compensé financièrement. (+4 Nourriture, -2 Or)", delegate () { Empire.instance.capitale.AddFood(4); Empire.instance.capitale.AddGold(-2); }));
        listeChoix.Add(new Dialog.Choix("Mes Citoyens iront collecter vos récoltes et elles seront ajoutées à vos réserves. (+1 Bonheur, -4 Or)", delegate () { Empire.instance.capitale.AddBonheur(1); Empire.instance.capitale.AddGold(-4); }));
        listeChoix.Add(new Dialog.Choix("Mes Citoyens vont les récolter pour l'empire. \n(+8 Nourriture, -1 Bonheur)", delegate () { Empire.instance.capitale.AddFood(8); Empire.instance.capitale.AddBonheur(-1); }));
        request = new Request(listMessage, listeChoix);
        listRandomRequest.Add(request);
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Votre mari cherche à préparer vos enfants à la dure réalité de la guerre. (-3 Bonheur)", delegate () { Empire.instance.capitale.AddBonheur(-3); }));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Mes soldats partiront à la recherche de ses voyous et ils paieront pour leurs crimes. (-2 Soldat, +1 Bonheur)", delegate () { Empire.instance.capitale.AddArmy(-2); Empire.instance.capitale.AddBonheur(1); }));
        listeChoix.Add(new Dialog.Choix("Votre fils devrait apprendre à se défendre. À partir d’aujourd’hui, il commencera sa formation militaire. (-1 Bonheur, +1 Soldat)", delegate () { Empire.instance.capitale.AddBonheur(-1); Empire.instance.capitale.AddArmy(1); }));
        request = new Request(listMessage, listeChoix);
        listRandomRequest.Add(request);
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Je suis en mesure de vous verser quelques pièces d’or à vous et votre famille. (-5 Or)", delegate () { Empire.instance.capitale.AddGold(-5); }));
        listeChoix.Add(new Dialog.Choix("Je vous offre une partie des réserves alimentaires de l’Empire ma chère dame.(-3 Nourriture)", delegate () { Empire.instance.capitale.AddFood(-3); }));
        listeChoix.Add(new Dialog.Choix("Les dieux nous soumettent parfois à des tests difficiles, mais votre famille doit surmonter cette épreuve seul ma chère dame. (-1 Bonheur)", delegate () { Empire.instance.capitale.AddBonheur(-1); }));
        request = new Request(listMessage, listeChoix);
        listRandomRequest.Add(request);
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Investir et construire l’arène (-12 Or, +3 Bonheur)", delegate () { Empire.instance.capitale.AddGold(-12); Empire.instance.capitale.AddBonheur(3);}));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Il s’agit d’une excellente proposition, voici les fonds nécessaires pour la construction de ce refuge. \n(-5 Nourriture, -10 Or, +3 Bonheur)", delegate () { Empire.instance.capitale.AddFood(-5); Empire.instance.capitale.AddGold(-10); Empire.instance.capitale.AddBonheur(3); }));
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("J’accepte d’entendre leur demande et de leur offrir quelques rations supplémentaire (-20 Nourriture)", delegate () { Empire.instance.capitale.AddFood(-20); }));
        listeChoix.Add(new Dialog.Choix("Les jeunes doivent faire leurs services militaires, de plein grès ou non. (-5 Bonheur)", delegate () { Empire.instance.capitale.AddBonheur(-5); }));
        listeChoix.Add(new Dialog.Choix("Je considère que cette requête est déraisonnable mon cher (-6 Soldats)", delegate () { Empire.instance.capitale.AddArmy(-8); }));
        request = new Request(listMessage, listeChoix);
        listRandomRequest.Add(request);
        ...
        listeChoix.Add(new Dialog.Choix("Je vais immédiatement corriger ce problème en ordonnant l’achat  de nouveaux bœufs. (-10 Or)", delegate () { Empire.instance.capitale.AddGold(-10);  }));
        listeChoix.Add(new Dialog.Choix("Les coffres de l’Empire ne me permettent pas une telle dépense en ce moment. (-2 Production Nourriture)", delegate () { Empire.instance.capitale.AddFoodProd(-1); }));
        request = new Request(listMessage, listeChoix);
        listRandomRequest.Add(request);
        ...
        listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Toutes les idées qui permettront d’augmenter la richesse de notre Empire seront les bienvenues.(-20 Or, +2 Production Or)", delegate () { Empire.instance.capitale.AddGold(-20); Empire.instance.capitale.AddGoldProd(2);  }));
    ...
    private Request PotionEvent2()
    {
        ...
        List<Dialog.Choix> listeChoix = new List<Dialog.Choix>();
        listeChoix.Add(new Dialog.Choix("Parfait ! Faite pousser ce blé !", delegate () { Empire.instance.capitale.AddFoodProd(1); }));
